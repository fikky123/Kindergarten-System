...
public final class viewupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <a href=\"viewreport.jsp\" onclick=\"w3_close()\" class=\"w3-bar-item w3-button w3-hover-white\">STUDENT REPORT</a> \n");
      out.write("    <a href=\"viewpaymentreport.jsp\" onclick=\"w3_close()\" class=\"w3-bar-item w3-button w3-hover-white\">PAYMENT REPORT</a>\n");
      ...
      out.write("    <h1 class=\"w3-jumbo\"><b>UPDATE STUDENT INFORMATION</b></h1>\n");
      out.write("  </div>\n");
      out.write("  \n");
      out.write("  <div id=\"live_data\"></div>\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("$(document).on('click', '#view', function (e) {\n");
      out.write("    \n");
      out.write("    \n");
      out.write("    var MYKID = $(this).data(\"id\");\n");
      out.write("    console.log(MYKID);\n");
      out.write("\n");
      out.write("    $.ajax({\n");
      out.write("    url: \"viewstudentdetailscontroller\",\n");
      out.write("    method: \"POST\",\n");
      out.write("    data: {MYKID: MYKID},\n");
      out.write("    dataType: \"text\",\n");
      out.write("    success: function (data) {\n");
      out.write("    console.log(data);\n");
      out.write("    window.location = \"viewstudentdetails.jsp\";\n");
      out.write("    }\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    });\n");
      out.write("function fetch_data() {\n");
      out.write("    $.ajax({\n");
      out.write("    url: \"viewreportcontroller\",\n");
      out.write("    method: \"POST\",\n");
      out.write("    datatype: \"text\",\n");
      out.write("    success: function (data) {\n");
      out.write("    $(live_data).html(data);\n");
      out.write("    console.log(data);\n");
      out.write("    }\n");
      out.write("    });\n");
      out.write("    }\n");
