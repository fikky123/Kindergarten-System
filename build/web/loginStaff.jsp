<%-- 
    Document   : loginStaff
    Created on : Sep 25, 2019, 1:39:56 AM
    Author     : admin
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <form action="LoginControllerStaff" method="post">
  <table class="w3-table">
	<tr><td><b>Staff ID</b></td>
    <td><input type="text" placeholder="Enter Staff ID" name="STAFF_ID"></td></tr>
